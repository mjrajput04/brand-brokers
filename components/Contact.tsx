        ...
        <div className="section-inner relative z-10">
          ...
          <div className="reveal max-w-2xl mx-auto mb-6">
            <button
              ...
              className="w-full group relative overflow-hidden rounded-3xl p-8 text-left transition-all duration-300 hover:scale-[1.01]"
              style={{ background: "linear-gradient(135deg, #ffffff 0%, #e5e7eb 100%)", boxShadow: "0 20px 60px rgba(255,255,255,0.15)" }}
            >
              <div className="flex items-start justify-between gap-6">
                <div className="flex items-start gap-5">
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(0,0,0,0.08)" }}>
                    <Calendar className="w-7 h-7 text-black" strokeWidth={1.5} />
                  </div>
                  <div>
                    <p className="font-black text-black text-xl mb-1">Book a Strategy Call</p>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      30-min call with our team. We'll talk about your brand goals, budget, and build a custom campaign plan.
                    </p>
                ...
                <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 mt-1 group-hover:scale-110 transition-transform" style={{ background: "rgba(0,0,0,0.1)" }}>
          ...
          <div className="reveal max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-white font-bold text-sm">founders@brandbrokers.in</p>
            ...
            <div className="p-8">
              ...
              <div className="flex flex-col gap-3 mb-8">
                {[
                  ...
                  { icon: CheckCircle, text: "Get a custom creator strategy — no fluff" },
