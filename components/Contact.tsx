...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-wrap relative overflow-hidden" style={{ background: "#0a0a0a" }}>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(168,85,247,0.15) 0%, transparent 70%)" }} />

      <div className="section-inner relative z-10">
        <div className="reveal text-center mb-14">
          <span className="section-label text-purple-400">Get In Touch</span>
        ...
        <div className="mt-20 pt-8 flex flex-col md:flex-row items-center justify-between gap-4" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          <div className="flex items-center gap-3">
            <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8">
              <rect x="2" y="2" width="16" height="16" rx="3" fill="#a855f7" />
              <rect x="22" y="2" width="16" height="16" rx="3" fill="rgba(168,85,247,0.5)" />
              <rect x="2" y="22" width="16" height="16" rx="3" fill="rgba(168,85,247,0.5)" />
              <rect x="22" y="22" width="16" height="16" rx="3" fill="#a855f7" />
            </svg>
            <span className="font-black text-white">BRAND BROKERS</span>
          </div>
          <p className="text-gray-600 text-sm">© 2025 Brand Brokers. For The Creators, By The Creators.</p>
        </div>
      </div>
    </section>
  );
