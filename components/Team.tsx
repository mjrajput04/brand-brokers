...
const team = [
  { name: "Rohit Chattopadhyay", role: "Co-Founder & CEO", emoji: "🚀", color: "#a855f7" },
  { name: "Arkajyoti Majumdar", role: "Co-Founder & CMO", emoji: "📊", color: "#7c3aed" },
  { name: "Sayak Daw", role: "Co-Founder & Head of Partnerships", emoji: "🤝", color: "#6d28d9" },
];
          ...
          {team.map((member, i) => (
            <div key={member.name} className="reveal card-hover group relative overflow-hidden rounded-3xl p-8 text-center cursor-default" style={{ background: "#0a0a0a" }}>
              ...
              <div className="relative mb-6 flex justify-center">
                <div className="w-24 h-24 rounded-full flex items-center justify-center text-4xl animate-float" style={{ background: `linear-gradient(135deg, ${member.color}33, ${member.color}11)`, border: `2px solid ${member.color}44`, animationDelay: `${i * 0.5}s` }}>
                  {member.emoji}
                </div>
