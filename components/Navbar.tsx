...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
          <video src="/logo/logo-anim.webm" autoPlay loop muted playsInline
            style={{ width: 90, height: 90, objectFit: "contain", flexShrink: 0, mixBlendMode: "screen" }} />
          <span className="font-black text-xl tracking-tight text-white" style={{ letterSpacing: "-0.02em" }}>
            BRAND BROKERS
          </span>
        </div>
      ...
      {/* Mobile menu */}
      <div className="lg:hidden overflow-hidden transition-all duration-500" style={{ maxHeight: open ? "500px" : "0" }}>
