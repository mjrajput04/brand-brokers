...
const cases = [
  ...
  {
    num: "02", brand: "INFINIX GT30 PRO", color: "#7c3aed",
  ...
  {
    num: "03", brand: "METASPACE", color: "#6d28d9",
...
export default function CaseStudies() {
  return (
    <section id="case-studies" className="section-wrap" style={{ background: "#f0ede8" }}>
      <div className="section-inner">
        <div className="reveal text-center mb-16">
          <span className="section-label text-purple-500">Proof of Work</span>
          <h2 className="section-heading">CASE STUDIES</h2>
        </div>

        <div className="flex flex-col gap-12">
          {cases.map((c) => (
            <div key={c.brand} className="reveal grid md:grid-cols-2 gap-10 items-start p-8 md:p-12 rounded-3xl" style={{ background: "#0a0a0a", border: `1px solid ${c.color}33` }}>
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <span className="font-black text-5xl" style={{ color: `${c.color}44`, lineHeight: 1 }}>{c.num}</span>
                  <div>
                    <p className="text-purple-400 text-xs font-bold tracking-widest uppercase">Case Study</p>
